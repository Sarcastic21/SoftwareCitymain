...
function PremiumCity() {
    ...
    useEffect(() => {
      // Fetch all reviews using the native fetch API
  ...
  <Link href="https://chat.whatsapp.com/YOUR_GROUP_LINK" target="_blank" className="whatsapp-link">Join Now</Link>
</div>
<div className="BANNER">
  ...
  <h1>
    <span className="highlight">Most</span> Popular
  </h1>
...
<div className="centered-text">
  ...
  <div className="service-card">
    <img src="https://imgs.search.brave.com/ajUS0lT3ttGJ2eW0dsSN3mU0ER7Iyvka5Y4Pd_jx9LE/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly90My5m/dGNkbi5uZXQvanBn/LzA0LzE3LzIwLzg4/LzM2MF9GXzQxNzIw/ODg3OV9FMWJnWWVx/cktYRElzZ2tLdmVG/Tmt5bmM2d2Z3ZHE2/aC5qcGc" alt="Netflix" className="service-image" />
    <h2>Netflix</h2>
    <Link to="https://software-city.netlify.app" className="service-button" target="_blank" rel="noopener noreferrer">Try Now</Link>
    </div>

  <div className="service-card">
    <img src="https://imgs.search.brave.com/A2FJWleEiIdwuew8T9CSoAQVVhm3RJroW4IoFHyFPmc/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly9saDMu/Z29vZ2xldXNlcmNv/bnRlbnQuY29tL1lq/TDBTQzRENGFRN2Zp/bWxGOFRmNG41MHhx/bVBhQnkzekZnQ2Fv/MmJFNTFuUFQzTTQz/QWMzbE5Ba3lnWjh0/a3M2UXl0anpRZW1C/ZFNLTVlfZmRlaThD/UU1sSFc2cVAyRGxC/LWR5RmM.jpeg" alt="YouTube Premium" className="service-image" />
    <h2>YouTube Premium</h2>
    <Link to="https://software-city.netlify.app" className="service-button" target="_blank" rel="noopener noreferrer">Try Now</Link>
    </div>

  <div className="service-card">
    <img src="https://imgs.search.brave.com/d-1wJozs-cgtLCV7_gThwrPlbGBFlSZkf3QIFDnXOWM/rs:fit:500:0:0:0/g:" alt="Amazon Prime" className="service-image" />
    <h2>Amazon Prime</h2>
    <Link to="https://software-city.netlify.app" className="service-button" target="_blank" rel="noopener noreferrer">Try Now</Link>
    </div>
</div>
...
<div className="centered-text">
  <h1>
    <span className="highlight">WHY</span> PREMIUMCITY SHOP 
  </h1>
  <div className="sketch-line"></div>
  <div className="centered-text">
        <img src={img21} alt="Shop" className="shop" />
      ...
      <h4 className='WHY'>
    <span className="highlight">At our Premium Shop, we’ve successfully completed over 850+ orders, with more than 250 satisfied customers who have rated us 5+.

We’re the best worldwide for OTT subscriptions, offering top-notch customer support. Don’t miss out on this opportunity!</span> 
  </h4>
  <Link to="https://www.amazon.com/prime" className="service-button" target="_blank" rel="noopener noreferrer">Try Now</Link>

  <div className="ott-section">
      <div className="ott-content">
        <div className="ott-images">
          <img
            src="https://t4.ftcdn.net/jpg/10/73/48/59/240_F_1073485978_sXtKc3Opz6nFWuSZw9CxnY5UNluYh2ai.jpg"
            alt="Tablet with OTT services"
...
<div className="promise-section">
      <div className="promise-content">
        <div className="promise-text">
          <h2>
            <span className="highlight">Our</span> Promise
          </h2>
      ...
      <div className="features-section acc2">
        <div className="feature-card">
          <div className="feature-icon">💡</div>
          <h3>SMART IDEAS</h3>
          <p>Trust takes years to build, seconds to break, and forever to repair. Others to achieve their dreams and you will achieve yours.</p>
        </div>
    ...
    <div className="centered-text">
  <h1>
    <span className="highlight">Customer</span> Rview
  </h1>
  <div className="sketch-line"></div>
</div>
